...
from .response import CalculatorResponse, PointsResponse
...
class Client:
    ...
    RAISE_EXC - выбрасывать исключение в случае ошибки api
    """
    DEFAULT_METHOD = 'post'
    RAISE_EXC = False
    ...
    def calculate(self, calculator: Calculator):
        ...
        return CalculatorResponse(self._exec_request("calculator", data))
    ...
    def get_points(self, limit: Optional[int] = None,
        ...
        return PointsResponse(self._exec_request("list_points", data))
